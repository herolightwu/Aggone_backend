    ...
    <header>
        <div class="container">
            <div class="header-data">
                <div class="logo">
                    <a href="{{ url('/') }}" title=""><img src="{{ asset('images/logo.jpg') }}" alt=""></a>
                </div><!--logo end-->
...
{{--                                    </div>--}}
                ...
                <div class="user-account">
                    <div class="user-info">
                        <img src="@if ($user->profile && $user->profile->avatar) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" alt="" style="height: 30px;">
                    ...
                    <div class="user-account-settingss" id="users">
                        ...
                        <h3 class="tc"><a href="javascript:;" title="" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></h3>
                                ...
                                <div class="user-data full-width">
                                    <div class="user-profile">
                                        <div class="username-dt">
                                            <div class="usr-pic">
                                                <img src="@if ($user->profile && $user->profile->avatar) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" alt="">
                                            </div>
                                        </div><!--username-dt end-->
                                    ...
                                    <div class="top-profiles">
                                        ...
                                        <div class="profiles-slider">
                                            <div class="user-profy">
                                                <img src="{{ asset('images/resources/user1.png') }}" alt="">
                                                <h3>John Doe</h3>
                                                <span>Graphic Designer</span>
                                                <ul>
                                                    <li><a href="#" title="" class="followw">Follow</a></li>
                                                    <li><a href="#" title="" class="envlp"><img src="{{ asset('images/envelop.png') }}" alt=""></a></li>
{{--                                                    <li><a href="#" title="" class="hire">hire</a></li>--}}
                                                </ul>
                                                <a href="#" title="">View Profile</a>
                                            </div><!--user-profy end-->
                                            <div class="user-profy">
                                                <img src="{{ asset('images/resources/user2.png') }}" alt="">
                                                <h3>John Doe</h3>
                                                <span>Graphic Designer</span>
                                                <ul>
                                                    <li><a href="#" title="" class="followw">Follow</a></li>
...
{{--                                                    <li><a href="#" title="" class="hire">hire</a></li>--}}
                                            ...
                                            <div class="user-profy">
                                                <img src="{{ asset('images/resources/user3.png') }}" alt="">
                                                <h3>John Doe</h3>
                                                <span>Graphic Designer</span>
                                                <ul>
                                                    <li><a href="#" title="" class="followw">Follow</a></li>
